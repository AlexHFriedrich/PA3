...
class Coresets:
    ...
    def _build_coreset(self):
        """
        Build a coreset of size coreset_size from the data according to the algorithm described in provided literature.
        :return: ids of the data points in the coreset and their corresponding weights to use for fitting
        """
    ...
    def fit(self):
        """
        Fit the kmeans algorithm to the coreset using the weights calculated in the coreset construction.
        """
